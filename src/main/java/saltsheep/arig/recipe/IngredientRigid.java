...
public class IngredientRigid extends IngredientCustom {

	public IngredientRigid(IngredientCustomFactory factory,boolean isIgnoreDamege,ItemStack... items) {
    ...
    public boolean apply(@Nullable ItemStack input) {
		...
		for(ItemStack item : this.getMatchingStacks()) {
			...
			if(itemEqual&&ItemStack.areItemStackShareTagsEqual(input, item))
				return true;
		}
		return false;
